# retrain.py
#
# Modified by : Kage Zhuang
#
# This file is original provided by Google. Slight modification is done.
...
MIN_NUM_IMAGES_REQUIRED_FOR_TESTING = 0
...
OUTPUT_DIR = os.getcwd() + "/" + ARCHITECTURE

# where to save the trained graph.txt
OUTPUT_GRAPH = OUTPUT_DIR + '/retrained_graph.pb'
...
OUTPUT_LABELS = OUTPUT_DIR + '/retrained_labels.txt'
...
BOTTLENECK_DIR = OUTPUT_DIR + '/bottleneck_data'
