...
// Purpose: Modification including:
//          1. Multiple model support
//          2. New prediction result label location
//
...
@interface RealTimeViewController (InternalMethods)
- (void)setupAVCapture;
